...
client = MongoClient("mongodb+srv://rahulharshawardhan:uyIAF7VZRnM9y3sn@cluster0.7mr9e03.mongodb.net/?retryWrites=true&w=majority")



DATA_FILE_PATH = (r"G:\Insurance Project\Insurance_Prediction\insurance.csv")
